...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_tip'])) {
    ...
    if (!empty($text)) {
        $stmt = $conn->prepare("INSERT INTO tips (text) VALUES (?)");
...
// --- Fetch all tips ---
$tips_result = $conn->query("SELECT * FROM tips ORDER BY created_at DESC");
...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="tips.php" class="active">Manage Tips</a></li>
                        ...
                        <?php if ($tips_result && $tips_result->num_rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td style="display: flex; gap: 8px;">
                                    <a href="edit_tip.php?id=<?php echo $row['id']; ?>" style="color: var(--accent); text-decoration: none; font-weight: 600;">Edit</a>
                                    <a href="tips.php?delete=<?php echo $row['id']; ?>" class="delete-btn" data-id="<?php echo $row['id']; ?>" style="color: #d9534f; text-decoration: none; font-weight: 600;">Delete</a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
